...
static const Rule rules[] = {
    ...
    {"snx-rs-gui",                      NULL,        NULL,           0,     1,   -1},
    {"Stoken-gui",                      NULL,        NULL,           0,     1,   -1},
    /* 1 - Code Tag */
...
static Keychord *keychords[] = {
    ...
    &((Keychord){2, {{MODKEY, XK_p}, {0, XK_d}},            spawn,          SHCMD("$XDG_SOURCE_HOME/dmenu/scripts/dmenu_drun") }),    /* Launch application launcher menu (desktop files) */
